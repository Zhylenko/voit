...
<body>
    ...
    <article class="fullback" id="fullback">
        ...
        <div class="container">
          ...
          <div class="header__top fix">
              ...
              <div class="header__group">
                <div class="logo">
                  <a class="logo__link" href="">
                    <picture class="logo__picture">
                      <source srcset="./img/лого-2.png" media="(max-width: 768px)">
                      <img src="./img/лого1.png" alt="logo">
                    </picture>
                  </a>
                </div>
                ...
                <nav class="menu">
                    <ul class="menu__list">
                      <li class="menu__item"><a class="menu__link" href="#home">Главная</a></li>
                      <li class="menu__item"><a class="menu__link" href="#about">О нас</a></li>
                      <li class="menu__item"><a class="menu__link" href="#programm">Программа</a></li>
                      <li class="menu__item"><a class="menu__link" href="#price">Цена</a></li>
                      <li class="menu__item"><a class="menu__link" href="#feedback">Отзывы</a></li>
                ...
                <div class="left-side">
                  ...
                  <div class="account">
                    ...
                    <a class="account__btn" href="./cabinet.html">
                      <img class="account__img" src="./img/user.svg" alt="user">
                    </a>
                  </div>
                </div>
          ...
          <div class="header__content fix">
            <div class="content__left">
              ...
              <div class="left__bottom">
                <div class="left__bottom-block">
                  ...
                  <img class="left__bottom-arrow" src="./img/arrow-to.svg" alt="arrow">
                </div>
  
                <button class="left__bottom-btn but-init popup-btn" id="popup-Btn">
                  Пройти Тест
                  <img src="./img/paper-plane.svg" alt="plane">
                </button>
            ...
            <div class="overlay__popup">
              <div class="popup__login modal">
                ...
                <div class="popup__login-top modal-top">
                  <img class="form__rect register__rect" src="./img/login-rect.svg" alt="">
              ...
              <div class="popup__test" style="display: none;">
                ...
                <div class="popup__group">
                  <button class="popup__group-btn" type="submit">
                    Да
                  </button>
                  <button class="popup__group-btn" type="submit">
                    Нет
            ...
            <div class="content__right">
                <img src="./img/header-image.svg" alt="graphic">
            </div>
          </div>
            ...
            <div class="container-main">
              <div class="about__inner">
                  ...
                  <div class="about__right">
                      <img src="./img/about-image.svg" alt="graphic">
                  </div>
              ...
              <div class="for__inner">
                ...
                <div class="for__items">
                    ...
                    <div class="for__items-top">
                      <div class="for__item">
                        <div class="for__item-circle">
                          <img class="for__item-img" src="./img/item-logo-1.svg" alt="logo">
                        </div>
                      ...
                      <div class="for__item">
                        <div class="for__item-circle">
                          <img class="for__item-img" src="./img/item-logo-2.svg" alt="logo">
                        </div>
                    ...
                    <div class="for__items-bottom">
                      <div class="for__item">
                        <div class="for__item-circle">
                          <img class="for__item-img" src="./img/item-logo-3.svg" alt="logo">
                        </div>
                      ...
                      <div class="for__item">
                        <div class="for__item-circle">
                          <img class="for__item-img" src="./img/item-logo-4.svg" alt="logo">
                        </div>
                ...
                <img class="for__img" src="./img/for-img.png" alt="graphic">
            ...
            <div class="container-main">
                <div class="programm__inner">
                  ...
                  <div class="programm__menu">
                    ...
                    <img class="programm__menu-image" src="./img/programm-img.svg" alt="graphic">
                  </div>
    
                  <div class="programm__btn">
                    <a class="programm__btn-submit but-init" href="#contact">Хочу записаться!</a>
                  </div>
                      ...
                      <div class="price__item">
                        ...
                        <div class="price__block">
                          <div class="price__logo">
                            <img src="./img/pr-logo-1.svg" alt="">
                          </div>
                          <img class="price__rect" src="./img/rect-card.png" alt="">
                  ...
                  <div class="footer__block">
                    ...
                    <div class="footer__left">
                        <div class="footer__item">
                          ...
                          <form class="contact__form" action="#" id="contact-form" novalidate>
                              ...
                              <div class="footer__block-nav">
                                ...
                                <div class="footer__nav-menu">
                                  <ul class="footer__nav-menu_l">
                                      <li class="menu__l-item"><a class="menu__f-link" href="#home">Главная</a></li>
                                      <li class="menu__l-item"><a class="menu__f-link" href="#about">О нас</a></li>
                                      <li class="menu__l-item"><a class="menu__f-link" href="#programm">Програма</a></li>
                                  </ul>

                                  <ul class="footer__nav-menu_r">
                                    <li class="menu__r-item"><a class="menu__f-link" href="#price">Цена</a></li>
                                    <li class="menu__r-item"><a class="menu__f-link" href="#feedback">Отзывы</a></li>
                                    <li class="menu__r-item"><a class="menu__f-link" href="#contact">Контакты</a></li>
                                  </ul>
                                </div>
                              ...
                              <div class="footer__block-help">
                                ...
                                <div class="footer__help-title foot-title">
                                  ...
                                  <ul class="footer__help">
                                      ...
                                      <li class="menu__help-item"><a class="menu__f-link" href="./offer.html">Тех. положение</a></li>                       
                                  </ul>
                              </div>
                          </div>
                              ...
                              <div class="footer__block-contact">
                                ...
                                <div class="footer__contact-desc">
                                    ...
                                    <div class="footer__desc-social">
                                      <a class="footer__social" href="#"><img src="./img/foot-face.svg" alt=""></a>
                                      <a class="footer__social" href="#"><img src="./img/foot-insta.svg" alt=""></a>
                                      <a class="footer__social" href="#"><img src="./img/foot-tel.svg" alt=""></a>
                                    </div>
                                </div>
                              </div>
                          </div>
