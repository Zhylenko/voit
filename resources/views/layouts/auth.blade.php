    ...
    <div class="overlay__popup">
        <div class="popup__login modal">
            ...
            <form class="popup__login-content" style="display: block;" id="login-form" action="#" novalidate>
                ...
                <div class="popup__login-btn">
                    <button class="login-btn reset-btn" id="reset-btn" type="button">Забыли пароль?</button>
                </div>
        ...
        <div class="popup__reset modal" style="display: none; left: 50%; top: 50%; transform: translate(-50%, -50%);">
                ...
                <form class="popup__reg-content" id="reset-form" action="#" novalidate>
                  ...
                  <span class="time">Поторная отправка: </span>
                  <span class="js-timeout" style="display: none;">1:00</span>
                  <button class="timer" type="submit" id="timer" style="display: none;">Отправить код повторно</button>

                  <button class="popup__reg-btn but-init reg-btn reset" type="submit" value="Reset" style="display: block;">Отправить код</button>
                </form>
